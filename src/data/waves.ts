...
export const STAGE_WAVES: readonly WaveDef[] = [
  ...
  /* 15 */ W(110, 38, ['hannya', 'nurikabe', 'tengu'], { boss: 'shuten' }),
  /* 16 */ W(122, 36, ['hannya', 'tengu']),
  /* 17 */ W(133, 34, ['tengu', 'nurikabe'], { swarm: { enemy: 'yosuzume', count: 80, formation: 'ring' } }),
  /* 18 */ W(144, 32, ['tengu', 'omukade']),
  /* 19 */ W(157, 30, ['tengu', 'omukade']),
  /* 20 */ W(170, 29, ['omukade', 'nue'], { boss: 'gashadokuro' }),
  /* 21 */ W(182, 28, ['omukade', 'nue']),
  /* 22 */ W(195, 27, ['nue']),
  /* 23 */ W(208, 26, ['nue', 'oni'], { swarm: { enemy: 'yosuzume', count: 100, formation: 'wall' } }),
  /* 24 */ W(222, 25, ['nue', 'oni']),
  /* 25 */ W(237, 24, ['oni'], { boss: 'shuten' }),
  /* 26 */ W(251, 23, ['oni', 'nue']),
  /* 27 */ W(266, 22, ['oni'], { swarm: { enemy: 'yosuzume', count: 120, formation: 'ring' } }),
  /* 28 */ W(282, 21, ['oni', 'nurikabe']),
  /* 29 */ W(304, 20, ['oni', 'nue', 'tengu'], { boss: 'gashadokuro' }),
];
