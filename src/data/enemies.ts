...
export const ENEMIES = {
  ...
  // --- minibosses (wave `boss` field; drop a chest)
  gashadokuro: { name: 'がしゃどくろ', sprite: 'boss_gashadokuro', hp: 3000, speed: 30, damage: 40, radius: 24, xp: 50, knockbackResist: 1 },
  shuten: { name: '酒呑童子', sprite: 'boss_shuten', hp: 9000, speed: 42, damage: 55, radius: 22, xp: 100, knockbackResist: 1 },
